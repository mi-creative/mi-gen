...
, 			{
				"box" : 				{
					...
					"style" : "",
					"text" : "Punctual mass (trapped between two fixed points).\n\nThe mass loses energy at each collision.\n\nIt is not subect to gravity."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 110.0, 70.0, 22.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 105.25, 85.0, 66.0, 36.0 ],
					"style" : "",
					"text" : "gen~ mass"
				}
