...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 28.0, 154.0, 144.0 ],
					"presentation" : 1,
					"presentation_linecount" : 5,
					"presentation_rect" : [ 1.375, 208.0, 411.0, 75.0 ],
					"style" : "",
					"text" : "The most basic behaviour is a linear visco-elastic spring (here connecting a fixed point to a mass).\nWhen initialised with a given position and velocity, the system oscillates.\n\nThis is the simplest of all interactions"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 110.0, 74.0, 22.0 ],
					"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 83.5, 169.944702, 69.0, 22.0 ],
									"style" : "",
									"text" : "* 9000000."
								}
