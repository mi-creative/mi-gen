...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 158.0, 307.0, 153.0, 172.0 ],
					"presentation" : 1,
					"presentation_linecount" : 6,
					"presentation_rect" : [ 0.0, 207.0, 333.0, 89.0 ],
					"style" : "",
					"text" : "The nlPluck interaction models plucking between one mass and another. In the first phase it acts like a contact module, pressing down (or up). Then, past a certain displacement, the pressure is released.\n\nUse it to pluck strings, membranes, or pretty much anything."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 113.0, 69.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 208.25, 138.5, 75.0, 22.0 ],
					"style" : "",
					"text" : "gen~ pluck"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 21.0, 73.0, 35.0, 22.0 ],
					"style" : "",
					"text" : "reset"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.0, 251.0, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 208.25, 116.5, 62.0, 20.0 ],
					"style" : "",
					"text" : "the patch:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 208.25, 10.75, 49.0, 22.0 ],
					"style" : "",
					"text" : "START"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 83.5, 169.944702, 62.0, 22.0 ],
									"style" : "",
									"text" : "* 100000."
								}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 334.75, 138.0, 52.5, 172.0 ],
					"pic" : "MI_MAT_Base_Plan.png",
					"presentation" : 1,
					"presentation_rect" : [ 10.25, 10.75, 52.5, 172.0 ],
					"yoffset" : 38.680835
				}
...
, 			{
				"box" : 				{
					...
					"numpoints" : 50,
					"outlettype" : [ "" ],
					"patching_rect" : [ 88.0, 212.0, 228.0, 212.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -25.0, -16.75, 228.0, 212.0 ],
					"subplots" : [ 						{
...
, 			{
				"box" : 				{
					...
					"numpoints" : 50,
					"outlettype" : [ "" ],
					"patching_rect" : [ 32.0, 309.0, 228.0, 212.0 ],
					"presentation" : 1,
					"presentation_rect" : [ -25.0, -16.75, 228.0, 212.0 ],
					"subplots" : [ 						{
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 426.0, 188.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 208.25, 86.0, 106.0, 23.0 ],
					"style" : "",
					"text" : "force(time)",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 252.0, 411.0, 188.0, 23.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 208.25, 61.0, 106.0, 23.0 ],
					"style" : "",
					"text" : "position(time)",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_matrix" ],
					"patching_rect" : [ 253.5, 44.0, 52.5, 172.0 ],
					"pic" : "MI_MAT_Digit.png",
					"presentation" : 1,
					"presentation_rect" : [ 10.25, 10.75, 52.5, 172.0 ],
					"yoffset" : 244.563671
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 178.0, 309.0, 128.0, 128.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.0, 0.0, 323.0, 193.5 ],
					"proportion" : 0.39,
					"style" : ""
				}
