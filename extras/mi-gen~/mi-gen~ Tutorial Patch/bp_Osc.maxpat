...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 38.5, 183.0, 52.5, 172.0 ],
					"pic" : "MI_MAT_Base_Plan.png",
					"presentation" : 1,
					"presentation_rect" : [ 13.25, 7.0, 52.5, 172.0 ],
					"yoffset" : 46.999894
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 410.0, 28.0, 159.0, 103.0 ],
					"presentation" : 1,
					"presentation_linecount" : 7,
					"presentation_rect" : [ 3.375, 162.0, 180.75, 103.0 ],
					"style" : "",
					"text" : "Integrated harmonic oscillator element.\n\nEquivalent to a mass, connected by a linear spring-damper to a fixed point in X = 0."
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 21.0, 110.0, 60.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.25, 85.0, 66.0, 22.0 ],
					"style" : "",
					"text" : "gen~ osc"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 176.5, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 105.25, 63.0, 62.0, 20.0 ],
					"style" : "",
					"text" : "the patch:"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 105.25, 32.0, 49.0, 22.0 ],
					"style" : "",
					"text" : "START"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 165.5, 228.0, 438.0, 38.0 ],
									"style" : "",
									"text" : "definerange -100 100, definethickness 1., definepoint dot, defineline lines, defineygrid 0."
								}
...
,
					"patching_rect" : [ 21.0, 146.0, 55.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 296.0, 52.5, 5.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.25, 123.5, 52.5, 5.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 38.5, 210.0, 52.5, 5.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 11.25, 35.0, 52.5, 5.0 ],
					"proportion" : 0.39,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 3.375, 5.25, 180.75, 153.5 ],
					"proportion" : 0.39,
					"style" : ""
				}
