...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 283.5, 87.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 248.0, 162.0, 59.0, 22.0 ],
					"style" : "",
					"text" : "parallel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 271.0, 128.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 649.0, 169.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "sizeinsamps 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 529.0, 169.0, 93.0, 22.0 ],
					"style" : "",
					"text" : "sizeinsamps 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 159.5, 56.0, 94.0, 23.0 ],
					"style" : "",
					"text" : "drunk 1700 50"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 122.5, 260.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 66.5, 260.0, 42.0, 22.0 ],
					"style" : "",
					"text" : "*~ 10."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 64.5, 219.486877, 139.0, 22.0 ],
					"style" : "",
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/CloudStation/Dev/MaxMSP/migen-formatting/Examples/DrunkTriangles/XL-Triangles",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
