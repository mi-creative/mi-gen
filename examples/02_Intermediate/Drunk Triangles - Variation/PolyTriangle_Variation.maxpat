...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 66.5, 219.486877, 151.0, 22.0 ],
					"style" : "",
					"text" : "poly~ unit_triangle_v2 100"
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "unit_triangle_v2.maxpat",
				"bootpath" : "~/CloudStation/Dev/MaxMSP/migen-formatting/Examples/DrunkTriangles/PercVariation",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
